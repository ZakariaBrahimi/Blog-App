...
class LoginForm(forms.Form):
    ...
    remember = forms.BooleanField(label=_("Remember Me"), required=False,
                                  widget=forms.CheckboxInput(attrs={
                                      'class':" mt-4 cursor-pointer form-checkbox text-gray-800 ml-1 w-5 h-5",
                                      'style': "transition: all 0.15s ease 0s;"
                                  })
                                  )
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ...
            login_widget = forms.TextInput(
                attrs={"placeholder": _("Username"), "autocomplete": "username",
                       'class':"px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full", 'style':"transition: all 0.15s ease 0s;",
                       }
            )
